...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		scanLine.startAnimation(animation);     //去掉scan-line的动画效果
	}
	...
	private void initCrop() {
		int cameraWidth = cameraManager.getCameraResolution().x;//changed
		int cameraHeight = cameraManager.getCameraResolution().y;//changed
